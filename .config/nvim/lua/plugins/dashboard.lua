...
local Dashboard = {
	...
	config = function()
		...
		dashboard.section.buttons.val = {
			...
			dashboard.button("SPC o  ", "󰈙  Recents", ":Telescope oldfiles<CR>"),
			dashboard.button("SPC w  ", "󰈭  Find Word", ":Telescope live_grep<CR>"),
			dashboard.button("SPC r  ", "  Last Session", function()
		...
		local function footer()
			...
			return string.format("⚡ %d/%d plugins loaded in %.2fms", plugin_load, plugin_count, load_time)
		end
